...
const PROVIDER_URL = process.env.HARDHAT_PROVIDER_URL
const provider = new ethers.JsonRpcProvider(PROVIDER_URL)

const USDT_ADDRESS = process.env.HARDHAT_MOCK_USDT_ADDRESS
const USDT_DECIMALS = 6
const PRICE_USDT = 10 // 10 USDT  
const PRICE_RAW = 10 * (10 ** USDT_DECIMALS) // 10 USDT
...
app.listen(PORT, () => {
    ...
    console.log(`Mock USDT at: ${USDT_ADDRESS}`);
});